...
const file_plugin_pb_base_v0_base_proto_rawDesc = "" +
	"\n" +
	"\x1cplugin-pb/base/v0/base.proto\x12\x05proto\"4\n" +
	"\aGetName\x1a\t\n" +
	"\aRequest\x1a\x1e\n" +
	"\bResponse\x12\x12\n" +
	...
	"\bResponse\x12\x14\n" +
	"\x05error\x18\x01 \x01(\tR\x05errorB4Z2github.com/cloudquery/plugin-pb-go/pb/base/v0;baseb\x06proto3"
