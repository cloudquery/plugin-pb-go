...
var file_plugin_pb_base_v0_base_proto_rawDesc = string([]byte{
...
var (
	...
	file_plugin_pb_base_v0_base_proto_rawDescData []byte
)

func file_plugin_pb_base_v0_base_proto_rawDescGZIP() []byte {
	file_plugin_pb_base_v0_base_proto_rawDescOnce.Do(func() {
		file_plugin_pb_base_v0_base_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_plugin_pb_base_v0_base_proto_rawDesc), len(file_plugin_pb_base_v0_base_proto_rawDesc)))
	})
...
func file_plugin_pb_base_v0_base_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_plugin_pb_base_v0_base_proto_rawDesc), len(file_plugin_pb_base_v0_base_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   0,
