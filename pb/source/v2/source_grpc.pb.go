...
const (
	Source_GetName_FullMethodName          = "/cloudquery.source.v2.Source/GetName"
	Source_GetVersion_FullMethodName       = "/cloudquery.source.v2.Source/GetVersion"
	Source_GetTables_FullMethodName        = "/cloudquery.source.v2.Source/GetTables"
	Source_GetMetrics_FullMethodName       = "/cloudquery.source.v2.Source/GetMetrics"
	Source_Init_FullMethodName             = "/cloudquery.source.v2.Source/Init"
	Source_GetDynamicTables_FullMethodName = "/cloudquery.source.v2.Source/GetDynamicTables"
	Source_Sync_FullMethodName             = "/cloudquery.source.v2.Source/Sync"
	Source_GenDocs_FullMethodName          = "/cloudquery.source.v2.Source/GenDocs"
)
...
func (c *sourceClient) Init(ctx context.Context, in *Init_Request, opts ...grpc.CallOption) (*Init_Response, error) {
	...
	err := c.cc.Invoke(ctx, Source_Init_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sourceClient) GetDynamicTables(ctx context.Context, in *GetDynamicTables_Request, opts ...grpc.CallOption) (*GetDynamicTables_Response, error) {
	...
	err := c.cc.Invoke(ctx, Source_GetDynamicTables_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sourceClient) GenDocs(ctx context.Context, in *GenDocs_Request, opts ...grpc.CallOption) (*GenDocs_Response, error) {
	...
	err := c.cc.Invoke(ctx, Source_GenDocs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSourceServer) GetDynamicTables(context.Context, *GetDynamicTables_Request) (*GetDynamicTables_Response, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDynamicTables not implemented")
}
...
func (UnimplementedSourceServer) GenDocs(context.Context, *GenDocs_Request) (*GenDocs_Response, error) {
	return nil, status.Error(codes.Unimplemented, "method GenDocs not implemented")
}
...
func _Source_GetDynamicTables_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Source_GetDynamicTables_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Source_GenDocs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Source_GenDocs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Source_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloudquery.source.v2.Source",
	...
	Metadata: "plugin-pb/source/v2/source.proto",
}
