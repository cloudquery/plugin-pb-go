...
const (
	Source_GetName_FullMethodName          = "/cloudquery.source.v1.Source/GetName"
	Source_GetVersion_FullMethodName       = "/cloudquery.source.v1.Source/GetVersion"
	Source_GetTables_FullMethodName        = "/cloudquery.source.v1.Source/GetTables"
	Source_GetMetrics_FullMethodName       = "/cloudquery.source.v1.Source/GetMetrics"
	Source_Init_FullMethodName             = "/cloudquery.source.v1.Source/Init"
	Source_GetDynamicTables_FullMethodName = "/cloudquery.source.v1.Source/GetDynamicTables"
	Source_Sync_FullMethodName             = "/cloudquery.source.v1.Source/Sync"
	Source_GenDocs_FullMethodName          = "/cloudquery.source.v1.Source/GenDocs"
)
...
var Source_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "plugin-pb/source/v1/source.proto",
}
