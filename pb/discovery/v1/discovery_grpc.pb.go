...
const (
	Discovery_GetVersions_FullMethodName = "/cloudquery.discovery.v1.Discovery/GetVersions"
)
...
func (c *discoveryClient) GetVersions(ctx context.Context, in *GetVersions_Request, opts ...grpc.CallOption) (*GetVersions_Response, error) {
	...
	err := c.cc.Invoke(ctx, Discovery_GetVersions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Discovery_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloudquery.discovery.v1.Discovery",
	...
	Metadata: "plugin-pb/discovery/v1/discovery.proto",
}
