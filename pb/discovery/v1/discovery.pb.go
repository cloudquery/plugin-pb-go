...
func file_plugin_pb_discovery_v1_discovery_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_plugin_pb_discovery_v1_discovery_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_plugin_pb_discovery_v1_discovery_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_plugin_pb_discovery_v1_discovery_proto_msgTypes[2].Exporter = func(v any, i int) any {
