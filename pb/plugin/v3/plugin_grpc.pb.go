...
func (UnimplementedPluginServer) GetSpecSchema(context.Context, *GetSpecSchema_Request) (*GetSpecSchema_Response, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSpecSchema not implemented")
}
...
func (UnimplementedPluginServer) TransformSchema(context.Context, *TransformSchema_Request) (*TransformSchema_Response, error) {
	return nil, status.Error(codes.Unimplemented, "method TransformSchema not implemented")
}
