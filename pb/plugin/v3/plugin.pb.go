...
var file_plugin_pb_plugin_v3_plugin_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_plugin_pb_plugin_v3_plugin_proto_goTypes = []interface{}{
	...
	(*Sync_Request)(nil),              // 18: cloudquery.plugin.v3.Sync.Request
	(*Sync_Response)(nil),             // 19: cloudquery.plugin.v3.Sync.Response
	(*Read_Request)(nil),              // 20: cloudquery.plugin.v3.Read.Request
	(*Read_Response)(nil),             // 21: cloudquery.plugin.v3.Read.Response
	(*Write_MessageMigrateTable)(nil), // 22: cloudquery.plugin.v3.Write.MessageMigrateTable
	(*Write_MessageInsert)(nil),       // 23: cloudquery.plugin.v3.Write.MessageInsert
	(*Write_MessageDeleteStale)(nil),  // 24: cloudquery.plugin.v3.Write.MessageDeleteStale
...
var file_plugin_pb_plugin_v3_plugin_proto_depIdxs = []int32{
	17, // 0: cloudquery.plugin.v3.Sync.Response.migrate_table:type_name -> cloudquery.plugin.v3.Sync.MessageMigrateTable
	16, // 1: cloudquery.plugin.v3.Sync.Response.insert:type_name -> cloudquery.plugin.v3.Sync.MessageInsert
	29, // 2: cloudquery.plugin.v3.Write.MessageDeleteStale.sync_time:type_name -> google.protobuf.Timestamp
	22, // 3: cloudquery.plugin.v3.Write.Request.migrate_table:type_name -> cloudquery.plugin.v3.Write.MessageMigrateTable
	23, // 4: cloudquery.plugin.v3.Write.Request.insert:type_name -> cloudquery.plugin.v3.Write.MessageInsert
	24, // 5: cloudquery.plugin.v3.Write.Request.delete:type_name -> cloudquery.plugin.v3.Write.MessageDeleteStale
	8,  // 6: cloudquery.plugin.v3.Plugin.GetName:input_type -> cloudquery.plugin.v3.GetName.Request
	10, // 7: cloudquery.plugin.v3.Plugin.GetVersion:input_type -> cloudquery.plugin.v3.GetVersion.Request
	12, // 8: cloudquery.plugin.v3.Plugin.Init:input_type -> cloudquery.plugin.v3.Init.Request
	14, // 9: cloudquery.plugin.v3.Plugin.GetTables:input_type -> cloudquery.plugin.v3.GetTables.Request
	18, // 10: cloudquery.plugin.v3.Plugin.Sync:input_type -> cloudquery.plugin.v3.Sync.Request
	20, // 11: cloudquery.plugin.v3.Plugin.Read:input_type -> cloudquery.plugin.v3.Read.Request
	25, // 12: cloudquery.plugin.v3.Plugin.Write:input_type -> cloudquery.plugin.v3.Write.Request
	27, // 13: cloudquery.plugin.v3.Plugin.Close:input_type -> cloudquery.plugin.v3.Close.Request
	9,  // 14: cloudquery.plugin.v3.Plugin.GetName:output_type -> cloudquery.plugin.v3.GetName.Response
	11, // 15: cloudquery.plugin.v3.Plugin.GetVersion:output_type -> cloudquery.plugin.v3.GetVersion.Response
	13, // 16: cloudquery.plugin.v3.Plugin.Init:output_type -> cloudquery.plugin.v3.Init.Response
	15, // 17: cloudquery.plugin.v3.Plugin.GetTables:output_type -> cloudquery.plugin.v3.GetTables.Response
	19, // 18: cloudquery.plugin.v3.Plugin.Sync:output_type -> cloudquery.plugin.v3.Sync.Response
	21, // 19: cloudquery.plugin.v3.Plugin.Read:output_type -> cloudquery.plugin.v3.Read.Response
	26, // 20: cloudquery.plugin.v3.Plugin.Write:output_type -> cloudquery.plugin.v3.Write.Response
	28, // 21: cloudquery.plugin.v3.Plugin.Close:output_type -> cloudquery.plugin.v3.Close.Response
...
func file_plugin_pb_plugin_v3_plugin_proto_init() {
	...
	file_plugin_pb_plugin_v3_plugin_proto_msgTypes[19].OneofWrappers = []interface{}{
		(*Sync_Response_MigrateTable)(nil),
		(*Sync_Response_Insert)(nil),
	}
	file_plugin_pb_plugin_v3_plugin_proto_msgTypes[25].OneofWrappers = []interface{}{
